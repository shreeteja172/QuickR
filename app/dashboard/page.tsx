    ...
    <main className="relative mx-auto max-w-[1280px] px-8 py-12 sm:px-10 lg:px-12 lg:py-16">
      <header className="mb-12 max-w-2xl">
        ...
        <p className="mt-4 text-[18px] leading-[1.50] text-slate">
          Generate new QR codes, jump into your history, and manage everything
          from one view.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-stone">
                  Transform any link or text into a scannable code.
                </p>
              </div>
              <Link
          ...
          >
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-stone">
                  Your latest generated codes
                </p>
              </div>
              <Link
                href="/dashboard/qr"
                className="text-sm font-medium text-primary hover:underline transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:rounded"
              >
                View all history
              </Link>
            </div>
            ...
            {qrCount === 0 ? (
              <div className="rounded-lg border border-hairline-soft bg-surface p-10 text-center">
                <div
                  className="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-cream border border-beige-deep"
                  aria-hidden="true"
                >
                  <svg
        ...
        <aside
          aria-label="Quick actions and workspace status"
          ...
          <div className="rounded-lg border border-hairline-soft bg-canvas p-8">
            ...
            <nav aria-label="Quick actions" className="mt-5 space-y-3">
              ...
              >
                ...
                <svg
                  className="h-4 w-4 text-stone transition group-hover:text-ink group-hover:translate-x-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  aria-hidden="true"
